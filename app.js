...
app.get('/colors', (req, res, next) => {
    ...
    res.render('color.ejs',{colors:colors});
});
const categories = ['Grayscale ','Red','Purple','Green','Pink','Yellow','Blue','Orange','Beige','Brown'];
app.get('/cat', (req, res, next) => {
    console.log('Categories colors');
    res.render('cat.ejs',{colors:colors,
cate:categories
    });
});
...
//  let blue = Math.floor(Math.random() * colors.length);
// randomColor.push(blue);
// });
// var randomColor = Math.floor(Math.random() * colors.length);


app.get('/rand', (req, res, next) => {
